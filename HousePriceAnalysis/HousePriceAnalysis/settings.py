"""
Django settings for HousePriceAnalysis project.
...
SECRET_KEY = 'yn_@4n+$i#qyi#4yb+(yt%%j^#)%6*e06fhh2d!2h=_ag(!%q!'
...
ROOT_URLCONF = 'HousePriceAnalysis.urls'
...
WSGI_APPLICATION = 'HousePriceAnalysis.wsgi.application'
